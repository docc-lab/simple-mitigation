...
type runtimeConfig struct {
	...
	// replica per tick: unix_ms,target,pod,yhat50,y50,y90,ext90,e_iso,n,applied_cap,ext50,e_horz.
	scoreTrace *os.File
}
...
func loadConfig() (*runtimeConfig, error) {
	...
	if p := os.Getenv("SCORE_TRACE"); p != "" {
		...
		if st, _ := f.Stat(); st != nil && st.Size() == 0 {
			fmt.Fprintln(f, "unix_ms,target,pod,yhat50,y50,y90,ext90,e_iso,n,applied_cap,ext50,e_horz")
		}
		scoreTrace = f
	}
